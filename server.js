...
function save(){ try{ fs.writeFileSync(DB_FILE, JSON.stringify({ guests, drivers, events, feedback })); }catch(e){} }
...
function snapshot(){ return { guests, drivers, events: events.slice(-400), feedback: feedback.slice(-200), venue: VENUE }; }
